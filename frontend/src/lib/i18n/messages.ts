...
const ZH: Record<MessageKey, string> = {
  ...
  'auth.codeSentTo': '验证码已发送至 {email}。Gmail 请同时查看垃圾邮件与「推广」标签，或等待 1–2 分钟',
  'auth.displayName': '昵称',
...
const EN: Record<MessageKey, string> = {
  ...
  'auth.codeSentTo': 'Code sent to {email}. Gmail users: check Spam/Promotions or wait 1–2 minutes',
