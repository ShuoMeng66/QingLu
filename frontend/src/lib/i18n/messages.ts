...
export type MessageKey =
  ...
  | 'settings.demoPresentation'
  | 'settings.demoPresentationHint'
  | 'settings.demoPresentationToggle'
  | 'settings.language'
  | 'settings.location'
  ...
  | 'toast.demoPresentationEnabled'
  | 'toast.demoPresentationDisabled'
  | 'toast.editingResend'
