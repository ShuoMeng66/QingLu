...
export const ZH: Record<MessageKey, string> = {
  ...
  'about.hackathon': '开源 AI 减脂管家 · 外卖 · 聚餐 · 训练 · 恢复',
  'about.title': '关于',
  ...
  'chat.notConnectedBanner': '服务未连接，无法发送消息。',
  'chat.notConnectedBannerExtra': ' 请在设置中配置百炼 API 后使用对话功能。',
  'chat.notConnectedBannerLink': '前往设置',
  'chat.emptyHint': '你的 AI 本地生活减脂管家 · 点击下方快捷入口开始对话。',
  'chat.emptyReply': '（暂无回复内容）',
  'chat.emptyTitle': '今天想聊点什么？',
  'chat.quickGridLabel': '快捷场景入口',
  ...
  'settings.aiOutputGuard': '对话拦截（展示前质检）',
  'settings.aiOutputGuardHint': '开启后，回复展示前会用快速模型检查异地门店、格式等问题；默认关闭。',
  ...
  'splash.scrollHint': '下滑了解轻鹭',
  'splash.trust1Title': '本地优先',
  'splash.trust1Desc': '数据隐私守护',
  'splash.trust2Title': '安全加密',
  'splash.trust2Desc': '账户独立隔离',
  'splash.trust3Title': '云端同步',
  'splash.trust3Desc': '随时继续旅程',
  ...
  'onboard.step2': '生成建议',
  'onboard.step3': '开始行动',
  'onboard.stepperAria': '建档进度',
  'onboard.trustNote': '仅用于生成个性化建议',
