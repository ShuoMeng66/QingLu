...
export const JA: Record<MessageKey, string> = {
  ...
  'about.hackathon': 'オープンソース AI ウェルネスコーチ',
  'about.title': 'について',
  ...
  'chat.notConnectedBanner': 'サービス未接続のため、メッセージを送信できません。',
  'chat.notConnectedBannerExtra': ' 設定で百煉 API を構成してから会話を開始してください。',
  'chat.notConnectedBannerLink': '設定へ',
  ...
  'settings.aiOutputGuard': '出力ガード（表示前チェック）',
  'settings.aiOutputGuardHint': '有効時、返信表示前に高速モデルで位置・形式をチェックします。デフォルトはオフ。',
