...
export const JA: Record<MessageKey, string> = {
  ...
  'profile.pageTitle': '健康プロフィール入力',
  'profile.saveSuccessTitle': 'プロフィールを保存しました',
  'profile.saveSuccessHint': 'プロフィールに基づき今日のプランを更新しました。概要を確認して続けてください。',
  'profile.continueToReady': '今日のプランを見る',
  'profile.editAgain': '修正に戻る',
  ...
  'quick.eat.label': '会食の食べ方',
  'quick.eat.prompt': '友人や会社の会食向けに、雰囲気を壊さずカロリーも抑えられる店と注文を提案して。',
  ...
  'splash.scrollHint': '下にスクロールして詳細へ',
  'splash.trust1Title': 'ローカル優先',
  'splash.trust1Desc': 'プライバシー保護',
  'splash.trust2Title': '安全暗号化',
  'splash.trust2Desc': 'アカウント分離',
  'splash.trust3Title': 'クラウド同期',
  'splash.trust3Desc': 'いつでも再開',
  ...
  'onboard.cta': '开始填写档案',
  'onboard.skip': '後で入力、まずチャットへ',
  'onboard.step1': 'プロフィール作成',
  'onboard.step2': '提案を生成',
  'onboard.step3': '開始',
  'onboard.stepperAria': 'オンボーディング進捗',
  'onboard.trustNote': 'パーソナル提案のためのみ使用',
  'ready.title': '{name}、プロフィールの準備ができました',
  'ready.subtitle': '長期の好みと今日の状態に基づき、今日のライトプランを用意しました。',
  'ready.summaryTitle': '長期の好み',
  'ready.goal': '目標：{value}',
  'ready.diet': '食事：{value}',
  'ready.avoid': '避けるもの：{value}',
  'ready.region': 'エリア：{value}',
  'ready.rowGoal': '目標',
  'ready.rowDiet': '食事の好み',
  'ready.rowAvoid': '制限・忌避',
  'ready.rowRegion': 'よく使うエリア',
  'ready.todayTitle': '今日の状態',
  'ready.remaining': '残りカロリー：{value} kcal',
  'ready.training': '今夜：{value}',
  'ready.location': '位置：{value}',
  'ready.body': '体調：{value}',
  'ready.rowRemaining': '残りカロリー',
  'ready.rowTraining': '今夜の予定',
  'ready.rowLocation': '現在地',
  'ready.rowBody': '体調',
  'ready.helpTitle': '軽鷺がお手伝いすること',
  'ready.helpTakeoutTitle': 'あなたに合うデリバリー提案',
  'ready.helpTakeoutDesc': '味・カロリー・続けやすさのバランス',
  'ready.helpTrainTitle': '近くのジム・クラスをマッチング',
  'ready.helpTrainDesc': '近くて効率的、科学的',
  'ready.helpRecoverTitle': '体調に合わせたリカバリー',
  'ready.helpRecoverDesc': '回復の質を上げ、疲労リスクを下げる',
  'ready.prioritiesTitle': '今日優先してお手伝いできること',
  'ready.startBtn': '今日の軽鷺プランを始める',
  'ready.editLink': 'プロフィールを修正 >',
  'today.defaultName': '你',
  ...
  'toast.demoPresentationEnabled': 'デモ展示を有効にしました',
  'toast.demoPresentationDisabled': 'デモ展示を無効にしました',
