...
export const KO: Record<MessageKey, string> = {
  ...
  'settings.demoPresentationHint': 'Presentation only. Scripts in demoPre/, isolated from normal chats.',
  ...
  'splash.scrollHint': '아래로 스크롤해 더 알아보기',
  'splash.trust1Title': '로컬 우선',
  'splash.trust1Desc': '개인정보 보호',
  'splash.trust2Title': '안전 암호화',
  'splash.trust2Desc': '계정 독립 격리',
  'splash.trust3Title': '클라우드 동기화',
  'splash.trust3Desc': '언제든 이어하기',
  ...
  'onboard.cta': '开始填写档案',
  'onboard.skip': '나중에 입력, 먼저 대화로',
  'onboard.step1': '프로필 만들기',
  'onboard.step2': '제안 생성',
  'onboard.step3': '시작',
  'onboard.stepperAria': '온보딩 진행',
  'onboard.trustNote': '맞춤 제안 생성에만 사용',
  ...
  'toast.demoPresentationEnabled': '데모 프레젠테이션 활성화',
  'toast.demoPresentationDisabled': '데모 프레젠테이션 비활성화',
