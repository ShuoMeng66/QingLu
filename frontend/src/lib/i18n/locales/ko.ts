...
export const KO: Record<MessageKey, string> = {
  ...
  'about.hackathon': '오픈소스 AI 웰니스 코치',
  'about.title': '정보',
  ...
  'chat.notConnectedBanner': '연결되지 않아 메시지를 보낼 수 없습니다.',
  'chat.notConnectedBannerExtra': ' 설정에서 Bailian API를 구성한 후 대화하세요.',
  'chat.notConnectedBannerLink': '설정 열기',
  ...
  'settings.aiOutputGuard': '출력 가드(표시 전 검사)',
  'settings.aiOutputGuardHint': '켜면 답변 표시 전 빠른 모델로 위치·형식을 검사합니다. 기본값은 꺼짐.',
