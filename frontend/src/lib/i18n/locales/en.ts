...
export const EN: Record<MessageKey, string> = {
  ...
  'about.hackathon': 'Open-source AI wellness coach · meals · dining · training · recovery',
  'about.title': 'About',
  ...
  'chat.notConnectedBanner': 'Not connected — messages cannot be sent.',
  'chat.notConnectedBannerExtra': ' Configure your Bailian API key in Settings to chat.',
  'chat.notConnectedBannerLink': 'Open settings',
  ...
  'chat.quickGridLabel': 'Quick scene shortcuts',
  ...
  'settings.aiOutputGuard': 'Output guard (pre-display review)',
  'settings.aiOutputGuardHint': 'When on, a fast model checks location mismatches and format issues before replies are shown. Off by default.',
  ...
  'onboard.step1': 'Create profile',
  'onboard.step2': 'Get suggestions',
  'onboard.step3': 'Start',
  'onboard.stepperAria': 'Onboarding progress',
  'onboard.trustNote': 'Used only to personalize suggestions',
